...
import {
  require_prop_types,
  require_react_is
} from "./chunk-V3BAU6SL.js";
import {
  _extends,
  init_extends
} from "./chunk-DHIQIRFA.js";
import {
  require_react_dom
...
var maybeReactUseId = React24["useId".toString()];
...
var ButtonGroupButtonContext = React43.createContext(void 0);
if (true) {
...
var Button = React44.forwardRef(function Button2(inProps, ref) {
  const contextProps = React44.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React44.useContext(ButtonGroupButtonContext_default);
